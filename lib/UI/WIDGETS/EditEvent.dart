...
class _EditEventState extends State<EditEvent> {
  ...
  saveTheEvent()async{
    ...
    Events theNewEvents = Events(widget.theEvents.eventID,userMap['id']!,'test',formattedDate,true,startEstimate,endEstimate,1,maxNumPeople,widget.thePlace.placeID,"aroma","");
